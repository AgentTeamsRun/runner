...
- [ ] `windows-native` 잡이 성공했고 PowerShell 5/7 contract fixture와
      `verify-packed-package.mjs`의 source/tarball 버전·SHA-256·`schemaVersion`·
      VERSIONINFO·산출물 디렉터리 검증이 모두 통과했는가?
